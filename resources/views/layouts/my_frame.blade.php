            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview projects feedbcacks">
                       ...
                       <li class="treeview staffs">
                        <a href="#">
                            <i class="fa fa-staffs"></i>
                            <span>Staffs</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        ...
                        <ul class="treeview-menu">
                            <li class="staffs_create"><a href="{{url('admin/staffs/create')}}"><i class="fa fa-circle-o"></i> Create staff</a></li>
                            <li class="staffs_list"><a href="{{url('admin/staffs')}}"><i class="fa fa-circle-o"></i> List staff</a></li>
                        </ul>
                    </li>
                     <li class="treeview contacts">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li class="contacts_create"><a href="{{url('admin/contacts/create')}}"><i class="fa fa-circle-o"></i> Create Contacts</a></li>
                            <li class="contacts_list"><a href="{{url('admin/contacts')}}"><i class="fa fa-circle-o"></i> List Contacts</a></li>
                        </ul>
                    </li>
